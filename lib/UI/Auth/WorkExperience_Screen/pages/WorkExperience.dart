...
import 'package:thementr/UI/Auth/WorkExperience_Screen/bloc/WorkExperience_event.dart';
...
class _WorkExperienceState extends State<WorkExperience> {
 ...
 ScrollController scrollController = ScrollController();
  ...
  final _WorkExperienceBloc = sl<WorkExperienceBloc>();
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder(
        bloc: _WorkExperienceBloc,
        builder: (BuildContext context, WorkExperienceState state) {
                  ...
                  child: ScrollConfiguration(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: (){
                            _WorkExperienceBloc.add(RemoveForm((b) => b..Index=index));
                          },
                          child: Container(
                            ...
                            child: Text("Remove",
                              ...
                              Container(
                                ...
                                child: textfeild(
                                  ...
                                  Controller: state.Forms![index].WorkPlaceNameController,
                                  Hint_Text: "",
                                  Onchanged: (va) {},
                                  validator:
                                  MultiValidator([
                            ...
                            style: Font1.copyWith(
                              ...
                              Container(
                                ...
                                child: textfeild(
                                  ...
                                  Onsubmitted: (String) {},
                                  TextInputaction: TextInputAction.newline,
                                  Controller: state.Forms![index].PositionHeldController,
                                  Hint_Text: "",
                                  Onchanged: (va) {},
                                  validator:
                                  MultiValidator([
                    ...
                    Container(
                      ...
                      child: textfeild(
                        ...
                        Onsubmitted: (String) {},
                        TextInputaction: TextInputAction.newline,
                        Controller: state.Forms![index].EndDateController,
                        Hint_Text: "",
                        Onchanged: (va) {},
                        validator:
                        MultiValidator([
                        ...
                        BorderRaduis: 10,
                              ...
                              Container(
                                ...
                                child: textfeild(
                                  ...
                                  Onsubmitted: (String) {},
                                  TextInputaction: TextInputAction.newline,
                                  Controller: state.Forms![index].StartDateController,
                                  Hint_Text: "",
                                  Onchanged: (va) {},
                                  validator:
                                  MultiValidator([
                    ...
                    InkWell(
                      onTap:(){
                        _WorkExperienceBloc.add(AddForm());
